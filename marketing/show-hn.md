...
- Crosswords are the same open themed grids with a clue per answer: 2,128 hand-written definition-style clues, checked by a test that no clue contains its answer; pasted lists take "word — clue" lines.
