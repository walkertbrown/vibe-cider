...
const PX_PATHS = new Set(["tool", "touched", "browsed", "click", "empty", "made", "failed", "handoff", "handofftop", "compare", "guide", "list", "listclick", "pay", "checkout", "unlock"].map((n) => `/px/${n}.gif`));
