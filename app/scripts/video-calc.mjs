...
await page.setContent(`<!doctype html><meta charset="utf-8"><style>
  ...
  <h1>Puzzle Press</h1><p>The calculators are free and always will be.</p><p>Free books carry one line in the page footer; $19 once removes it.</p><div class="u">puzzlepress.bananafest-destiny.com</div>`);
