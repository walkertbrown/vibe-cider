...
await pin("03-word-search.png", {
  ...
  body: "66 built-in themes or paste your own list. Every word appears exactly once — checked, not hoped.",
  img: png(wsPdf, 4),
...
await pin("07-crossword.png", {
  ...
  body: "Plain-language clues for 2,285 words across 66 themes, or paste your own word — clue lines. Solutions at the back.",
  img: png(xwPdf, 20),
