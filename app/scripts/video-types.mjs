...
const types = [
  ["wordsearch", "Word search — 51 themes or your own list. Every word once, checked.", ".grid div"],
  ...
  ["crossword", "Themed crosswords — 1,797 clues written by hand, or paste your own.", ".crisscross .cell i"],
];
const pdfs = {};
