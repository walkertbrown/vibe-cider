...
const types = [
  ["wordsearch", "Word search — 81 themes or your own list. Every word once, checked.", ".grid div"],
  ...
  ["crossword", "Themed crosswords — 2,086 clues written by hand, or paste your own.", ".crisscross .cell i"],
];
const pdfs = {};
