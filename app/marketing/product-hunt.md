...
- Likely questions, worth having answers ready for:
  ...
  - *Isn't there a free tool that does this?* Yes, and for some people it's the better answer — PuzzleForge is free, no account, no watermark, and bulk-generates 50 puzzles with answer keys. The difference is puzzles versus a book: its own FAQ says "Save PDF" opens your browser's print dialog, so you get puzzle pages — no title or copyright page, no page numbers, no padding to KDP's 24-page minimum or an even page count, no inside margin by page count, and no cover. The cover is the wall, because the spine width comes from the page count of the book you just made. Side-by-side: /compare
