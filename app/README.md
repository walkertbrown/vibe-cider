...
and [themed clued crosswords](https://puzzlepress.bananafest-destiny.com/crossword-book-generator),
plus a [large-print preset](https://puzzlepress.bananafest-destiny.com/large-print-word-search-generator)
at 8.5×11 sized for older eyes. Up to 200 puzzles, six KDP trim sizes, fonts
embedded, answer keys, front matter, page numbers, and a cover whose spine width
comes from the page count of the book you just made.
...
Every sample below was generated by this code and is committed to the repo under
`public/samples/`. Interiors are 20 puzzles with solutions; each cover is the
single full-wrap PDF KDP asks for, with the spine sized to that book's page
count.

| Type | Interior | Cover |
|---|---|---|
| Word search | [6×9](https://puzzlepress.bananafest-destiny.com/samples/sample-6x9.pdf) | [wrap](https://puzzlepress.bananafest-destiny.com/samples/sample-cover-6x9.pdf) |
| Large print | [8.5×11](https://puzzlepress.bananafest-destiny.com/samples/sample-large-print-8.5x11.pdf) | [wrap](https://puzzlepress.bananafest-destiny.com/samples/sample-large-print-cover-8.5x11.pdf) |
| Sudoku | [6×9](https://puzzlepress.bananafest-destiny.com/samples/sample-sudoku-6x9.pdf) | [wrap](https://puzzlepress.bananafest-destiny.com/samples/sample-sudoku-cover-6x9.pdf) |
| Mazes | [6×9](https://puzzlepress.bananafest-destiny.com/samples/sample-maze-6x9.pdf) | [wrap](https://puzzlepress.bananafest-destiny.com/samples/sample-maze-cover-6x9.pdf) |
| Criss-cross | [6×9](https://puzzlepress.bananafest-destiny.com/samples/sample-crisscross-6x9.pdf) | [wrap](https://puzzlepress.bananafest-destiny.com/samples/sample-crisscross-cover-6x9.pdf) |
| Crosswords | [6×9](https://puzzlepress.bananafest-destiny.com/samples/sample-crossword-6x9.pdf) | [wrap](https://puzzlepress.bananafest-destiny.com/samples/sample-crossword-cover-6x9.pdf) |
...
The KDP arithmetic this code had to get right internally is also published as
single-purpose pages, because getting any of it wrong is a rejected file or a
book that earns less than it should:
...
- [How to make a puzzle book](https://puzzlepress.bananafest-destiny.com/how-to-make-a-puzzle-book)
  — the 24-page minimum, the even-page rule, and the traps around both.
